...
"""
Fenesan Daria Georgiana - Group 913
"""
...
if __name__ == '__main__':
    ...
    ax1.plot_surface(Xline, Yline, Zline, alpha=0.7, color='orange')
    z0 = f(-1, -1, A1)
    ...
    ax4.plot_surface(Xline, Yline, Zline, alpha=0.7, color='orange')
    z0 = f(1, 1, A2)
    ...
    ax2.plot_surface(Xline, Yline, Zline, alpha=0.7, color='orange')
    z0 = f(-1, -1, A3)
    ax2.scatter(-1, -1, z0, color='black')

    Zline = get_z_line_for_function(Xline, Yline, A4)
    ax5.plot_surface(Xline, Yline, Zline, rstride=1, cstride=1, cmap='viridis', edgecolor='none', alpha=0.7)
    Zline = get_z_line_for_gradient_plane(Xline, Yline, A4, 1, 1)
    ax5.plot_surface(Xline, Yline, Zline, alpha=0.7, color='orange')
    z0 = f(1, 1, A4)
    ...
    ax3.plot_surface(Xline, Yline, Zline, alpha=0.7, color='orange')
    z0 = f(-1, -1, A5)
    ax3.scatter(-1, -1, z0, color='black')

    Zline = get_z_line_for_function(Xline, Yline, A6)
    ax6.plot_surface(Xline, Yline, Zline, rstride=1, cstride=1, cmap='viridis', edgecolor='none', alpha=0.7)
    Zline = get_z_line_for_gradient_plane(Xline, Yline, A6, 1, 1)
    ax6.plot_surface(Xline, Yline, Zline, alpha=0.7, color='orange')
    z0 = f(1, 1, A6)
